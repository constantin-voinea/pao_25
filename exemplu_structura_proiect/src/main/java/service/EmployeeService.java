...
public class EmployeeService {
     ...
     *
     * @param id the cnp of entity to remove
     * @throws CustomException if the provided id does not refer an existing record
     */
    public void removeEmployeeById(String id) throws CustomException {
        Optional<Employee> employee = employeeRepository.findById(id);
        employee.ifPresent(employeeRepository::delete);
        if (employee.isEmpty()) {
            throw new CustomException("Cannot delete the employee with provided identity: " + id + " It does not exist!");
        }
